...
int main(int argc, char* argv[]) {
  ...
  for (int eventProgenitorBinIndex = 1; eventProgenitorBinIndex <= templateReader.nEventProgenitorMassBins; ++eventProgenitorBinIndex) {
	...
	std::string massBinID = "_eventProgenitorMass_" + std::to_string(int(0.5 + (templateReader.eventProgenitorMasses).at(eventProgenitorBinIndex))) + "_neutralinoMass_" + std::to_string(int(0.5 + (templateReader.neutralinoMasses).at(neutralinoBinIndex)));
	histograms_deltaR_closestGenJet[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_deltaR_closestGenJet" + massBinID).c_str(), ("h_deltaR_closestGenJet" + massBinID + ";deltaR_closestGenJet;photons").c_str(), 200, -0.15, 3.85);
	histograms_deltaR_secondClosestGenJet[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_deltaR_secondClosestGenJet" + massBinID).c_str(), ("h_deltaR_secondClosestGenJet" + massBinID + ";deltaR_secondClosestGenJet;photons").c_str(), 200, -0.15, 3.85);
	histograms_photonPT[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_photonPT" + massBinID).c_str(), ("h_photonPT" + massBinID + ";photonPT;photons").c_str(), 250, 0., 1500.);
	histograms_closestGenJet_PT[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_closestGenJet_PT" + massBinID).c_str(), ("h_closestGenJet_PT" + massBinID + ";closestGenJet_PT;photons").c_str(), 250, 0., 1500.);
	histograms_closestGenJet_fraction_EM[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_closestGenJet_fraction_EM" + massBinID).c_str(), ("h_closestGenJet_fraction_EM" + massBinID + ";closestGenJet_fraction_EM;photons").c_str(), 103, -0.015, 1.015);
	histograms_closestGenJet_fraction_hadronic[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_closestGenJet_fraction_hadronic" + massBinID).c_str(), ("h_closestGenJet_fraction_hadronic" + massBinID + ";closestGenJet_fraction_hadronic;photons").c_str(), 103, -0.015, 1.015);
	histograms_closestGenJet_fraction_invisible[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_closestGenJet_fraction_invisible" + massBinID).c_str(), ("h_closestGenJet_fraction_invisible" + massBinID + ";closestGenJet_fraction_invisible;photons").c_str(), 103, -0.015, 1.015);
	histograms_closestGenJet_fraction_aux[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_closestGenJet_fraction_aux" + massBinID).c_str(), ("h_closestGenJet_fraction_aux" + massBinID + ";closestGenJet_fraction_aux;photons").c_str(), 103, -0.015, 1.015);
	histograms_closestGenJet_totalFraction[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_closestGenJet_totalFraction" + massBinID).c_str(), ("h_closestGenJet_totalFraction" + massBinID + ";closestGenJet_totalFraction;photons").c_str(), 103, -0.015, 1.015);
	histograms_secondClosestGenJet_PT[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_secondClosestGenJet_PT" + massBinID).c_str(), ("h_secondClosestGenJet_PT" + massBinID + ";secondClosestGenJet_PT;photons").c_str(), 250, 0., 1500.);
	histograms_secondClosestGenJet_fraction_EM[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_secondClosestGenJet_fraction_EM" + massBinID).c_str(), ("h_secondClosestGenJet_fraction_EM" + massBinID + ";secondClosestGenJet_fraction_EM;photons").c_str(), 103, -0.015, 1.015);
	histograms_secondClosestGenJet_fraction_hadronic[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_secondClosestGenJet_fraction_hadronic" + massBinID).c_str(), ("h_secondClosestGenJet_fraction_hadronic" + massBinID + ";secondClosestGenJet_fraction_hadronic;photons").c_str(), 103, -0.015, 1.015);
	histograms_secondClosestGenJet_fraction_invisible[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_secondClosestGenJet_fraction_invisible" + massBinID).c_str(), ("h_secondClosestGenJet_fraction_invisible" + massBinID + ";secondClosestGenJet_fraction_invisible;photons").c_str(), 103, -0.015, 1.015);
	histograms_secondClosestGenJet_fraction_aux[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_secondClosestGenJet_fraction_aux" + massBinID).c_str(), ("h_secondClosestGenJet_fraction_aux" + massBinID + ";secondClosestGenJet_fraction_aux;photons").c_str(), 103, -0.015, 1.015);
	histograms_secondClosestGenJet_totalFraction[eventProgenitorBinIndex][neutralinoBinIndex] = TH1F(("h_secondClosestGenJet_totalFraction" + massBinID).c_str(), ("h_secondClosestGenJet_totalFraction" + massBinID + ";secondClosestGenJet_totalFraction;photons").c_str(), 103, -0.015, 1.015);
      }
    }
  }
